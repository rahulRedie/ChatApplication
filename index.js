...
server.listen(process.env.PORT || 3001, () => console.log("running on port 3001"));
const { Server } = require("socket.io");
const io = new Server(server, {
    cors: {
        origin: process.env.PORT|| "http://localhost:3000", //if you change your frontend url enter it here
        credentials: true,
    },
});
...
const db = mysql.createConnection({
    ...
    database: "chatapp", //database name 
});
// const db = mysql.createConnection(
